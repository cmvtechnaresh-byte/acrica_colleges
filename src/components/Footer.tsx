      ...
      <div className="py-12 px-6 md:px-[calc(18vw-10rem)]">
        <div className="max-w-[138rem] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-6">
                <button
                  ...
                  className={`text-[1.4rem] font-medium transition-colors ${theme === "light"
                ...
                <button
                  ...
                  className={`text-[1.4rem] font-medium transition-colors ${theme === "dark"
                    ? "text-foreground underline decoration-2 underline-offset-4"
                    : "text-muted-foreground"
                    }`}
                ...
                <button
                  ...
                  className={`text-[1.4rem] font-medium transition-colors ${theme === "system"
                    ? "text-foreground underline decoration-2 underline-offset-4"
                    : "text-muted-foreground"
                    }`}
            ...
            {/* Column 2: Legal & Copyright (Merged since other links are gone) */}
            <div className="flex flex-col gap-3">
